...
export default function FloatingCTA() {
  return (
    <aside aria-label="Hỗ trợ khẩn cấp" className="fixed bottom-5 right-4 sm:right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
      
      {/* 24/7 Emergency Quick Indicator */}
      <div className="pointer-events-auto hidden sm:flex items-center gap-2 bg-emergency-500 text-white text-xs font-bold px-3.5 py-1.5 rounded-full shadow-lg animate-pulse">
        <AlertTriangle className="w-3.5 h-3.5" />
        <span>Cấp cứu 24/7 Long Biên - Gia Lâm</span>
      </div>

      {/* Button: Facebook Messenger (Official Messenger Logo) */}
      <a
