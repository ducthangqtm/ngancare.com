...
export const INITIAL_SERVICES: Service[] = [
  {
    ...
    duration: 75,
    description:
      'Massage xoang nang sữa chuẩn y khoa kết hợp sóng siêu âm đa tần.',
    features: [
      'Không đau đớn, không bóp nặn',
      'Sóng siêu âm đa tần',
      'Chườm thảo dược',
    ],
  ...
  },
  {
    ...
    duration: 45,
    description:
      'Vệ sinh rốn vô khuẩn 100%, massage kích thích tiêu hóa và hơ lá trầu.',
    features: [
      'Điều dưỡng y tế trực tiếp tắm',
      'Vệ sinh rốn vô khuẩn',
      'Hơ lá trầu ấm',
    ],
    image_url: '/images/banner.jpg',
    is_active: 1,
