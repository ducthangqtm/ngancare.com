    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <main className="flex-1 p-6 sm:p-10 max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Dịch Vụ Chăm Sóc</p>
              <h3 className="text-2xl sm:text-3xl font-black text-charcoal-900 mt-1">
                {servicesCount !== null ? (
                  servicesCount
                ) : (
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Bài Viết Blog Mẹ & Bé</p>
              <h3 className="text-2xl sm:text-3xl font-black text-charcoal-900 mt-1">
                {postsCount !== null ? (
                  postsCount
                ) : (
              ...
              <p className="text-[11px] text-blue-600 font-medium mt-1">Chuẩn SEO Google</p>
            </div>
