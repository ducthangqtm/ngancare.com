...
import { Package, Plus, Trash2, Edit2, Check, X, Clock, DollarSign, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <main className="flex-1 p-6 sm:p-10 max-w-7xl overflow-x-auto">
        <div className="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-charcoal-900">Dịch Vụ & Sản Phẩm</h1>
            <p className="text-xs sm:text-sm text-gray-500 mt-1">
              Quản lý danh sách dịch vụ y tế tại nhà và catalog sản phẩm thiên nhiên cho mẹ và bé.
            </p>
          </div>
          ...
          >
            ...
            <span>{isAdding ? 'Đóng Form' : 'Thêm Dịch Vụ / Sản Phẩm'}</span>
          </button>
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="san_pham">Sản Phẩm Thiên Nhiên</option>
                  </select>
                </div>
