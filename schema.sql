...
-- 4. Bảng Bài Viết Blog Cẩm Nang Mẹ & Bé
CREATE TABLE IF NOT EXISTS posts (
    id TEXT PRIMARY KEY,
    title TEXT NOT NULL,
    slug TEXT UNIQUE NOT NULL,
    excerpt TEXT,
    content TEXT NOT NULL, -- Nội dung HTML / Markdown bài viết
    cover_image TEXT,
...
('srv-03', 'Chăm Sóc & Phục Hồi Toàn Diện Mẹ Sau Sinh', 'cham-soc-phuc-hoi-me-sau-sinh', 'sau_sinh', 500000, 90,
 'Gói phục hồi chuyên sâu kết hợp tinh hoa thảo dược cổ truyền và kỹ thuật xoa bóp hiện đại. Giúp mẹ giảm đau mỏi lưng hông, co hồi tử cung nhanh chóng, đào thải sản dịch và lấy lại vóc dáng thon gọn.',
